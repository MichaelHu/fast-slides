!function(n){function t(){p||(p=!0,u(y,function(n){f(n)}))}function e(t,e){var a=n.createElement("script");a.type="text/"+(t.type||"javascript"),a.src=t.src||t,a.async=!1,a.onreadystatechange=a.onload=function(){var n=a.readyState;!e.done&&(!n||/loaded|complete/.test(n))&&(e.done=!0,e())},(n.body||v).appendChild(a)}function a(n,t){return n.state==O?t&&t():n.state==b?E.ready(n.name,t):n.state==S?n.onpreload.push(function(){a(n,t)}):(n.state=b,void e(n.url,function(){n.state=O,t&&t(),u(h[n.name],function(n){f(n)
}),c()&&p&&u(h.ALL,function(n){f(n)})}))}function o(n){void 0===n.state&&(n.state=S,n.onpreload=[],e({src:n.url,type:"cache"},function(){r(n)}))}function r(n){n.state=j,u(n.onpreload,function(n){n.call()})}function c(n){n=n||w;var t;for(var e in n){if(n.hasOwnProperty(e)&&n[e].state!=O)return!1;t=!0}return t}function i(n){return"[object Function]"==Object.prototype.toString.call(n)}function u(n,t){if(n){"object"==typeof n&&(n=[].slice.call(n));for(var e=0;e<n.length;e++)t.call(n,n[e],e)}}function d(n){var t;
if("object"==typeof n)for(var e in n)n[e]&&(t={name:e,url:n[e]});else t={name:l(n),url:n};var a=w[t.name];return a&&a.url===t.url?a:(w[t.name]=t,t)}function l(n){var t=n.split("/"),e=t[t.length-1],a=e.indexOf("?");return-1!=a?e.substring(0,a):e}function f(n){n._done||(n(),n._done=1)}var s,p,v=n.documentElement,y=[],m=[],h={},w={},L=n.createElement("script").async===!0||"MozAppearance"in n.documentElement.style||window.opera,g=window.head_conf&&head_conf.head||"head",E=window[g]=window[g]||function(){E.ready.apply(null,arguments)
},j=1,S=2,b=3,O=4;if(E.js=L?function(){var n=arguments,t=n[n.length-1],e={};return i(t)||(t=null),u(n,function(o,r){o!=t&&(o=d(o),e[o.name]=o,a(o,t&&r==n.length-2?function(){c(e)&&f(t)}:null))}),E}:function(){var n=arguments,t=[].slice.call(n,1),e=t[0];return s?(e?(u(t,function(n){i(n)||o(d(n))}),a(d(n[0]),i(e)?e:function(){E.js.apply(null,t)})):a(d(n[0])),E):(m.push(function(){E.js.apply(null,n)}),E)},E.ready=function(t,e){if(t==n)return p?f(e):y.push(e),E;if(i(t)&&(e=t,t="ALL"),"string"!=typeof t||!i(e))return E;
var a=w[t];if(a&&a.state==O||"ALL"==t&&c()&&p)return f(e),E;var o=h[t];return o?o.push(e):o=h[t]=[e],E},E.ready(n,function(){c()&&u(h.ALL,function(n){f(n)}),E.feature&&E.feature("domloaded",!0)}),window.addEventListener)n.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1);else if(window.attachEvent){n.attachEvent("onreadystatechange",function(){"complete"===n.readyState&&t()});var A=1;try{A=window.frameElement}catch(C){}!A&&v.doScroll&&function(){try{v.doScroll("left"),t()
