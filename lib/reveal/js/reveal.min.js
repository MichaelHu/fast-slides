...
}function mt(){if(ct()===!1)if(Z().up)ht();else{var e=document.querySelector(Qt+".past:nth-child("+Xt+")");if(e){var t=e.querySelectorAll("section").length-1||void 0,n=Xt-1;W(n,t)}}}function bt(){st()===!1&&(Z().down?gt():vt()),lt()}function yt(){Jt.autoSlideStoppable&&ut()}function wt(e){yt(e),document.activeElement;var t=!(!document.activeElement||!document.activeElement.type&&!document.activeElement.href&&"inherit"===document.activeElement.contentEditable);if(!(t||e.shiftKey&&32!==e.keyCode||e.altKey||e.ctrlKey||e.metaKey)){if(F()&&-1===[66,190,191].indexOf(e.keyCode))return!1;
